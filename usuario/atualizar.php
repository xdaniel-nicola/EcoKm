                ...
                <div class="form-grid">
                    <div class="column">
                        ...
                        <div class="email">
                            ...
                            <input class="inputs" type="text" name="email" id="email" placeholder="Digite seu e-mail" oninput="emailValidate()" value="<?php echo isset($usuario['email']) ? htmlspecialchars($usuario['email']) : ''; ?>">
                            <span class="span-required">Digite um e-mail válido.</span>
                        </div>
                        <div class="cpf">
                            <label for="cpf">CPF:</label>
                            <input class="inputs" maxlength="14" type="text" name="cpf" id="cpf" placeholder="000.000.000-00" oninput="cpfValidate()" value="<?php echo isset($usuario['cpf']) ? htmlspecialchars($usuario['cpf']) : ''; ?>">
                            <span class="span-required">Digite um CPF válido.</span>
                        </div>
                        <div class="dt_nasc">
                            <label for="dt_nasc">Data de nascimento:</label>
                            <input class="inputs" maxlength="10" type="text" name="dt_nasc" id="dt_nasc" placeholder="dd/mm/aaaa" oninput="dateValidate()" value="<?php echo $data_formatada; ?>">
                        ...
                        <div class="sexo">
                            ...
                            <select required class="sexos" name="sexo" id="sexo" onchange="sexoValidate()">
                                ...
                                <option value="Masculino" <?php echo (isset($usuario['sexo']) && trim($usuario['sexo']) == 'Masculino') ? 'selected' : ''; ?> value="1" >Masculino</option>
                                <option value="Feminino" <?php echo (isset($usuario['sexo']) && trim($usuario['sexo']) == 'Feminino') ? 'selected' : ''; ?> value="2">Feminino</option>
                                <option value="Outro" <?php echo (isset($usuario['sexo']) && trim($usuario['sexo']) == 'Outro') ? 'selected' : ''; ?> value="3">Outro</option>
                            </select>
                    ...
                    <div class="column">
                        ...
                        <div class="senha">
                            ...
                            <ul id="password-requirements">
                                <li id="length" class="invalid">Confirme sua senha novamente para confirmar a atualização.</li>
                            </ul>
                        </div>
